    ...
    members :
    {
        ...
        basicInfoJsonData : function(context)
        {
            return { 
                ...
                weightBw            : context._weightBw.getValue(),
                freeShipping        : context._freeShipping.getValue(),
                highlightItem       : context._highlightItem.getValue(),
                onSale              : context._onSale.getValue(),
                ean                 : context._ean.getValue(),
                width               : context._width.getValue(),
                height              : context._height.getValue(),
                length              : context._length.getValue(),
